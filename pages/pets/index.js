...
export default function Posts({ posts }) {
  ...
  return (<>
    <HeadMetadata title='Cent Blog | Pets updates' metaDescription="Get latest update on pets around the world!" />
...
export const getServerSideProps = async () => {
  const ref = await db.collection('posts').where('category', '==', 'pets').limit(20).get();
