...
export default function Posts({ posts }) {
  ...
  return (<>
    <HeadMetadata title='Cent Blog | Tech updates' metaDescription="Get latest update on tech around the world!" />
...
export const getServerSideProps = async () => {
  const ref = await db.collection('posts').where('category', '==', 'tech').limit(20).get();
